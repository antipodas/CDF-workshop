...
- Step 3: Go back to NiFi UI and click on settings top right corner
  ...
  - Click on Registry Clients
  - Add Registry
  - URL: **http://demo.cloudera.com:18080**
  ![Add Registry](images/add-registry.png)

- Step 4: Go back to NiFi UI and right click on the previously created process group
...
- Step 5: Get in the CDF Workshop (double click on the process group) and add a **ConnectWebSocket** processor to the canvas
...
- Step 6: Add an UpdateAttribute connector to the canvas and link from ConnectWebSocket on **text message** relationship
  - Double click on the processor
...
- Step 7: Add EvaluateJsonPath to the canvas and link from UpdateAttribute on **success** relationship
  - Double click on the processor
...
- Step 8: Add an AttributesToCSV processor to the canvas and link from EvaluateJsonPath on **matched** relationship
  - Double click on the processor
...
- Step 9: Add a PutFile processor to the canvas and link from AttributesToCSV on **success** relationship
  - Double click on the processor
  - On settings tab, check all relationships
  - Change **Directory** value to **/tmp/workshop**
  - Apply changes

- Step 10: Right-click anywhere on the canvas and commit your first flow!
